import json
file_path = r"/Users/grit/PycharmProjects/LongEmo/dataset/Emotion_QA.jsonl"
...
results = agent.process_texts(
    texts=text,
    question=problem,  # ✅ 这里传 labels 而不是 custom_prompt
    save_path=r"/Users/grit/PycharmProjects/LongEmo/result/qa_emotion_results_deepseek_r1_en.log"
)
